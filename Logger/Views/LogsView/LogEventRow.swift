    ...
    var body: some View {
        GeometryReader { _ in
            HStack {
                ...
                Text(model.category).frame(width: 350, alignment: .leading).padding(EdgeInsets(top: 0, leading: 20, bottom: 0, trailing: 10))
                Text(model.subsystem).frame(width: 500, alignment: .leading).padding(EdgeInsets(top: 0, leading: 20, bottom: 0, trailing: 10))
                Text(model.message).frame(alignment: .leading).padding(EdgeInsets(top: 0, leading: 20, bottom: 0, trailing: 10))
